...
local themeStyles = {
    ...
    Synapse = {
        ...
        Header = Color3.fromRGB(28, 22, 18),
    ...
    function Tabs:NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewSlider(text, desc, max, min, callback, displayFormatter)
                ...
                sliderBar.BackgroundColor3 = themeList.ElementColor:Lerp(Color3.new(1,1,1),0.05)
                ...
                local function UpdateText(v)
                    ...
                    if displayFormatter then
                        local success, formatted = pcall(function()
                            return displayFormatter(v)
                        end)

                        if success and formatted ~= nil then
                            result = tostring(formatted)
                        else
                            result = tostring(v)
                        end
                    else
                    ...
                    if input.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        moveConn = mouse.Move:Connect(function()
                            ...
                            local percent = math.clamp(
                                (mouse.X - sliderBar.AbsolutePosition.X) / sliderBar.AbsoluteSize.X,
                                0,1
                            )
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback, multi)
                ...
                -- DESCRIPTION (same system as other elements)
                ...
                dropOpen.MouseButton1Click:Connect(function()
                    ...
                    if opened then
                        dropFrame:TweenSize(
                            UDim2.new(0,352,0,layout.AbsoluteContentSize.Y),
                    ...
                    for _,v in ipairs(optionList) do
                        ...
                        option.MouseButton1Click:Connect(function()
                            ...
                            if multi then
                                ...
                                if #ordered > 0 then
                                    itemTextbox.Text = table.concat(ordered,", ")
                                else
                                    itemTextbox.Text = dropname
                                end
                                ...
                                opened = false
                                dropFrame:TweenSize(UDim2.new(0,352,0,33),"InOut","Linear",0.08,true)
