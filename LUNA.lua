...
local Luna = { 
	Folder = "Luna", 
	Options = {}, 
	ThemeGradient = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(25, 25, 40)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(50, 50, 80)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(120, 120, 200))} 
}
...
local PresetGradients = {
    NeonSun = {Color3.fromRGB(255, 170, 60), Color3.fromRGB(200, 120, 40), Color3.fromRGB(120, 70, 30)},
	...
	function Window:CreateTab(TabSettings)
		...
		function Tab:CreateSection(name : string)
			...
			function Section:CreateDropdown(DropdownSettings, Flag)
				...
				-- FIXED: ActivateColorSingle now properly handles theme colors
				...
				-- FIXED: Refresh now properly sets attributes and handles theme colors
				...
				-- FIXED: Initial selection highlighting now uses attributes
		...
		function Tab:CreateDropdown(DropdownSettings, Flag)
			...
			-- Fix the initial selection highlighting
			if type(bleh) == "string" then 
				for _, Option in pairs(Dropdown.List:GetChildren()) do
					if Option.ClassName == "TextLabel" and Option:GetAttribute("RealName") == bleh then
						local base = Option:GetAttribute("ThemeTextColor")
            ...
            Tab:CreateButton({
                ...
                Callback = function()
                    ...
                    if not success then
                        Luna:Notification({
                            Title = "Interface",
                            Content = "Save failed: " .. (err or "Unknown error")
                        })
                        return
                    else
                        Luna:Notification({
